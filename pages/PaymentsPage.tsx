...
const PaymentsPage: React.FC = () => {
    ...
    const GatewayButton = ({ name, enabled, onClick }: { name: string, enabled: boolean, onClick: () => void }) => (
        <button 
            onClick={onClick}
            disabled={!enabled}
            className={`w-full text-left p-4 border rounded-lg transition ${enabled ? 'hover:border-primary hover:bg-primary/5 cursor-pointer' : 'bg-gray-100 text-gray-400 cursor-not-allowed'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                     <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <p className="text-sm text-gray-600 mb-4">Select your preferred payment method to pay your dues.</p>
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-lg">
                        <div className="p-6">
                             <div className="flex justify-between items-start">
                                <h3 className="text-xl font-semibold text-gray-900">Manual Payment</h3>
                                <button onClick={() => setShowManualPaymentModal(false)} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                            ...
                            <div className="mt-4 space-y-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 whitespace-pre-wrap">{settings.paymentGateways.manualPaymentInstructions}</p>
                                </div>
                                <div>
                                    <FileUpload 
                        ...
                        <div className="flex items-center justify-end p-6 space-x-2 border-t border-gray-200 rounded-b">
                            <button onClick={() => setShowManualPaymentModal(false)} className="bg-gray-200 text-dark py-2 px-6 rounded-md hover:bg-gray-300 transition">Cancel</button>
