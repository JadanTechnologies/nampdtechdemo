...
const ConferencePage: React.FC = () => {
    ...
    const renderIdleState = () => (
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg text-center">
            ...
            <h2 className="text-2xl font-semibold text-dark dark:text-gray-100 mb-4">Virtual Conference Room</h2>
            ...
            {isConfigured() ? (
                ...
                <div className="max-w-md mx-auto my-6 p-4 bg-yellow-50 border border-yellow-300 rounded-md dark:bg-yellow-900/50 dark:text-yellow-300 dark:border-yellow-500/30">
