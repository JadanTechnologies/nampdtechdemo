...
const ApprovalsPage: React.FC = () => {
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold text-dark mb-6">Approvals Queue</h1>
            <div className="bg-white p-6 rounded-lg shadow-lg">
                {loading ? (
                    <div className="flex justify-center items-center h-64"><Spinner size="lg" /></div>
                ) : pendingMembers.length === 0 ? (
                    <p className="text-center text-gray-500 py-8">No pending approvals at the moment.</p>
                ) : (
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-full overflow-y-auto">
                        <div className="p-6">
                            <div className="flex justify-between items-start">
                                ...
                                <button onClick={() => setSelectedMember(null)} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
