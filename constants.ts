...
const createInitialMembers = (): MemberApplication[] => {
    ...
    const members: MemberApplication[] = [
        { id: 'mem-001', userId: 'user-004', fullName: 'Bisi Adekunle', nin: '12345678901', phone: '08012345678', email: 'member@test.com', state: 'Lagos', lga: 'Ikeja', businessName: 'Bisi\'s Ventures', businessAddress: '123 Allen Avenue, Ikeja', passportPhotoUrl: 'https://picsum.photos/seed/mem001/200/200', ninSlipUrl: 'https://picsum.photos/seed/nin001/400/250', status: MembershipStatus.ACTIVE, accountStatus: 'Active', forumStatus: 'active', registrationDate: new Date(today.setDate(today.getDate() - 30)).toISOString() },
        { id: 'mem-002', userId: 'user-005', fullName: 'Chidi Okoro', nin: '23456789012', phone: '08023456789', email: 'pending@test.com', state: 'Rivers', lga: 'Port Harcourt', status: MembershipStatus.PENDING_CHAIRMAN, accountStatus: 'Active', forumStatus: 'active', registrationDate: new Date(today.setDate(today.getDate() - 5)).toISOString() },
        { id: 'mem-003', userId: 'user-006', fullName: 'Fatima Bello', nin: '34567890123', phone: '08034567890', email: 'payment@test.com', state: 'Kano', lga: 'Kano', status: MembershipStatus.PENDING_PAYMENT, accountStatus: 'Active', forumStatus: 'active', registrationDate: new Date(today.setDate(today.getDate() - 10)).toISOString() },
        { id: 'mem-004', userId: 'user-007', fullName: 'David Samuel', nin: '45678901234', phone: '08045678901', email: 'state@test.com', state: 'Lagos', lga: 'Surulere', status: MembershipStatus.PENDING_STATE, accountStatus: 'Active', forumStatus: 'active', registrationDate: new Date(today.setDate(today.getDate() - 2)).toISOString() },
        { id: 'mem-005', userId: 'user-008', fullName: 'Ngozi Eze', nin: '56789012345', phone: '08056789012', email: 'rejected@test.com', state: 'Enugu', lga: 'Enugu', status: MembershipStatus.REJECTED, accountStatus: 'Deactivated', forumStatus: 'banned', registrationDate: new Date(today.setDate(today.getDate() - 15)).toISOString() },
        { id: 'mem-006', userId: 'user-009', fullName: 'Musa Ibrahim', nin: '67890123456', phone: '08067890123', email: 'musa@test.com', state: 'Kaduna', lga: 'Kaduna', status: MembershipStatus.ACTIVE, accountStatus: 'Active', forumStatus: 'active', registrationDate: new Date(today.setDate(today.getDate() - 60)).toISOString() },
    ];
    return members;
};
